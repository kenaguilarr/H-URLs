...
def main():
    ...
    dataPreprocessFromCSV("Data/malicious_phish.csv", input_ids, input_types, input_masks, label)
    ...
    model.load_state_dict(torch.load("model.pth"))  # Load model parameters
